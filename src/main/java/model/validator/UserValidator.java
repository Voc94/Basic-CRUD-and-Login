...
public class UserValidator {
    ...
    // "  a b c d  " -- trim() -->  "a b c d" pentru a nu lasa parole de genu "    " doar spatii
    private boolean containsSpecialCharacter(String password){
        if(password == null || password.trim().isEmpty()){
            return false;
        }
        //foarte multe charactere speciale, pentru a elimina doar cele gresite
        // mai bine facem un:
        //Black List:
        ...
        return specialCharactersMatcher.find(); // find return True sau False
    }
